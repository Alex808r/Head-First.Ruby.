...
#Игра угадай число от 1 до 100 c циклом upto и оператором case
...
1.upto(10) do |i| # можно также применить цикл downto
  ...
  case
  when choice == number then puts "Хорошая работа #{name}, число отгадано c #{i} раза!\n\n"
    exit
  when choice > number then puts "Oops. Ваше число больше загаданного. Попробуйте еще.\n\n"
  when choice < number then puts "Oops. Ваше число меньше загаданного. Попробуйте еще.\n\n"
  end
end
